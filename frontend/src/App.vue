      ...
      <div class="header-container">
        <div class="header-left">
          ...
          <router-link to="/" class="logo">
            <svg height="28" viewBox="0 0 24 24" width="28" fill="none" stroke="currentColor" stroke-width="2" style="color: var(--color-primary); margin-right: 4px;">
        ...
        <div class="header-right">
          <a href="https://github.com/BriskAM/orbit" target="_blank" class="header-repo-link">
